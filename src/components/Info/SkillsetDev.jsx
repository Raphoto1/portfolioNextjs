...
export default function SkillsetDev() {
  const frontEnd = [
    { name: "TEch", strenght: 20, image: "path" },
    { name: "TEch2", strenght: 30, image: "path" },
    { name: "TEch3", strenght: 40, image: "path" },
    { name: "TEch3", strenght: 40, image: "path" },
  ];
  ...
  return (
    <>
      <Box display={"flex"} flexDirection={"column"}>
        <Box display={"flex"} w={"100vw"} justifyContent={"center"} justifyItems={"center"} justifySelf={"center"} pb={10}>
          <TextAnimBold text={`Skillset`} />
        </Box>
        <Box display={"flex"} w={"100vw"} flexFlow={"wrap"} justifyContent={"space-evenly"}>
