      ...
      <Box display={"flex"} justifyContent={"space-evenly"} flexWrap={"wrap"} w={"100%"}>
        {data.map((itm) => (
          <Box
            ...
            alignSelf={"start"}
            pb={['2vh',"1vh"]}>
            <Box py={"2vw"} pt={['2vh',"5vh"]} pb={"4vh"} w={"33%"} h={"100%"} display={"flex"} justifyContent={"center"} alignItems={"center"}>
            ...
            <Box display={"flex"} justifyContent={"center"} maxW={"10vw"} pt={['0vh','2vh']}>
